...
"""
Example of using depth first search (DFS) to find a spanning tree
...
python3 dfs.py [ --seed int ] [ --num_v int ] [ --num_e int ] [ --root v ]

Try with:
    python3 dfs.py --seed 23 --num_v 20 --num_e 30 --root 0
...
dot_file_name = "dfs-spanning-tree.dot"
